                ...
                <div class="col-md-6 col-lg-4 col-xlg-3">
                    <div class="card card-hover">
                        <div class="box bg-cyan text-center">
                            ...
                            <h4 class="text-white"><b>RAGUL RAJA C</b></h4>
                        </div>
                    </div>
                </div>
                <!-- Column -->
                <div class="col-md-6 col-lg-4 col-xlg-3">
                    <div class="card card-hover">
                        <div class="box bg-success text-center">
                            ...
                            <h4 class="text-white"><b>2022-2026</b></h4>
                        </div>
                    </div>
                </div>
                 <!-- Column -->
                                                    ...
                                                    <div class="bo">
                                                        <div class="content1">
                                                            <div class="stats-box text-center p-3" style="background-color:rgb(252, 119, 71);">
                                                                ...
                                                                <small class="font-light">Today's appointment</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="bo">
                                                        <div class="content1">
                                                            <div class="stats-box text-center p-3" style="background-color:rgb(241, 74, 74);">
                                                                ...
                                                                <h1 class="m-b-0 m-t-5"></h1>
                                                                <small class="font-light">New Appointment</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="bo">
                                                        <div class="content1">
                                                            <div class="stats-box text-center p-3" style="background-color:rgb(70, 160, 70);">
                                                                ...
                                                                <h1 class="m-b-0 m-t-5"></h1>
                                                                <small class="font-light">Completed Appointment</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
